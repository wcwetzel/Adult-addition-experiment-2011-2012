...
inits = function() list(a=1.5, q=0.5, b=-0.5, logk=0, O = ifelse(d$f>0, 1, 0))

# parms
parms = c('p', 'b', 'a', 'q', 'logk')
...
####### R2jags #########
nb2fglin = jags(data, inits, parms, 'adult-addition-galls-dd.txt', n.chains=3, n.iter=ni, n.thin=thin)
