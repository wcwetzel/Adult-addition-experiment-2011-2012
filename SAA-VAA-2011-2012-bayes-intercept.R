# SAA-VAA-2011-2012 Bayesian - intecept - just R and p
...
######## DIC
dic1 = dic.samples(mrj, n.iter=ni, thin=thin, type='pD')
dic1 = dic.samples(mrj, n.iter=50000, type='popt')


####### R2jags
set.seed(1)
m0 = jags(data, inits, parms, 'adult-addition.txt', n.chains=3, n.iter=ni)
